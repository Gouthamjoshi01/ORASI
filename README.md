...
> Insert your custom terminal screenshot showing the active cyan slant logo, the right-aligned blossoms, and the samurai dividing blade here!
...
sudo python3 scanner.py -sS -O --min-rate 500 10.49.169.61

# Execute a network scan utilizing random decoy targets and custom data length padding
sudo python3 scanner.py -D RND:5 --data-length 25 10.49.169.61
